		...
		{!loaded ? (
			<div className='WebLoader'>
			    ...
			    <div>
								...
								<div className="row">
									<div className="col-xs-12">
										<div className="banner-heading">
											<h1 className="border-title border-left">About Us</h1>
					...
					<section id="main-container" className="main-container pt-50">
						<div className="container">
							<div className="row">
								<div className="col-md-8">
										<div className="profile-content">
											<h3 className="border-title border-left mar-t0">Profile</h3>
								...
								<div className="col-md-12">
									<div className="mission-content pt-100">
										<h3 className="border-title border-left mar-t0">Mission</h3>
								...
								<div className="col-md-12">
									<div className="vission-content pt-100">
										<h3 className="border-title border-left mar-t0">Vission</h3>
